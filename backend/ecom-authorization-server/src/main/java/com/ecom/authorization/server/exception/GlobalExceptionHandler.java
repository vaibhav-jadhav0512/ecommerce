...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ErrorResponse> handleInvalidRegException(JwtTokenExpiredException ex,
			WebRequest request) {
		log.info("Handling JwtTokenExpiredException");
		String errorCode = env.getProperty(ExceptionConstantsMap.JWT_TOKEN_EXPIRED_EXCEPTION);
